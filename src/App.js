...
import Cart from './Screen/Cart/CarListings'; // Cart screen
...
import OldCars from '../src/Screen/Products/states';
  ...
  return (
    <div className="App">
      ...
      <Routes>
        ...
        {/* Old Car listing page */}
        <Route path="/states/:category" element = {<OldCars />} />
